        ...
        <>
            <div className="mod content-union">
                <header className="content-header">
                    <a className={`content-mas-leidas-title ${showAlM ? "active-AL" : ""}`} onClick={showAlM ? (()=>setShowAlM(true)):(()=>setShowAlM(!showAlM))}>Al Momento</a>
                    <div className="separacion"></div>
                    <a className={`content-al-momento-title ${!showAlM ? "active-AL" : ""}`} onClick={!showAlM ? (()=>setShowAlM(false)):(()=>setShowAlM(!showAlM))}>Mas Leídas</a>
                </header>
                    ...
                    {showAlM ? (
                        <>
                            {alMomento.response.map((momento, index) =>(
                                <li key={momento.nid}>
                                    <span className="number">{hora(momento.created)}</span>
