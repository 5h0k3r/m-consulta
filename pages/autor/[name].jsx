...
const PaginationAutor = dynamic(() => import('../../components/PaginationAutor/PaginationAutor'))
...
export default function Autor(){
    ...
    return(
        <Template>
            <Head>
                <title>{name} | e-cosulta.com </title>
                <script 
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify({
                    ...
                    "url": `${process.env.eConsultaCanonical+'autor/'+name}`,
                    "logo": {
                    "@type":"ImageObject",
